...
function results_ajax_load_stage_sections() {
    ...
    wp_send_json_success(array('sections'=>$sections, 'results'=>$results));
}
function results_ajax_save_stage_section() {
    check_ajax_referer('result_settings_actions_nonce','nonce'); results_install_stage_sections_schema(); $link=db_connect();
